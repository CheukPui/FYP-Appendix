            ...
            for gcode, pattern in patterns.items():
                if gcode in line:
                    ...
                    for match in matches:
                        ...
                        if values[0] == 0.0 and values[1] == 300.0:
                            values[2] = 237
                        else:
    ...
    if len(array[count]) == 3:
        if array[count][0] == 0:
            ...
            if arm.error_code == 0 and not params['quit']:
                print (array[count][1])
                code = arm.set_position(x=array[count][1], y=array[count][0], z=array[count][2], roll=-3.14, pitch=0, yaw=-0.76, is_radian=True)
                if code != 0:
                    params['quit'] = True
